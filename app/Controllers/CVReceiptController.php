...
use Point\Models\Receipt\CV\ItemsReceipt;
use Point\Models\Receipt\CV\OrdersReceipt;
use Psr\Http\Message\ServerRequestInterface;
use Point\Interfaces\ReceiptControllerInterface;

class CVReceiptController
{
    ...
    public function store(ServerRequestInterface $request, ResponseInterface $response, Auth $auth, Router $router, Messages $flash)
    {
        ...
        return $response->withRedirect($router->pathFor('cvReceipts.show', ['id' => $receiptId]));
    }
    ...
    public function create(ServerRequestInterface $request, ResponseInterface $response, Twig $twig)
    {
        if (isset($_GET['customer'])) {
            ...
            return $twig->render($response, 'receipt/cv/create.twig', compact('customerName', 'workOrders')); 
        } else {
            $customerName = null;
            return $twig->render($response, 'receipt/cv/create.twig', compact('customerName'));
        }
    }
    ...
    public function settledList(ServerRequestInterface $request, ResponseInterface $response, Twig $twig)
    {
        ...
        return $twig->render($response, 'receipt/cv/settled.twig', compact('receipts'));
    }
    ...
    public function canceledList(ServerRequestInterface $request, ResponseInterface $response, Twig $twig)
    {
        ...
        return $twig->render($response, 'receipt/cv/canceled.twig', compact('receipts'));
    }
    ...
    public function debtList(ServerRequestInterface $request, ResponseInterface $response, Twig $twig)
    {
        ...
        return $twig->render($response, 'receipt/cv/debt.twig', compact('receipts'));
    }
    ...
    public function show(ServerRequestInterface $request, ResponseInterface $response, Twig $twig, $id)
    {
        if (Receipt::find($id)) {
            ...
            return $twig->render($response, 'receipt/cv/show.twig', compact('receipt', 'workOrders', 'items'));
        }     
    ...
    public function settled(ServerRequestInterface $request, ResponseInterface $response, Router $router, Messages $flash, $id)
    {
        if (Receipt::find($id)) {
            ...
            return $response->withRedirect($router->pathFor('cvReceipts.show', ['id' => $id]));
        }
    }
    ...
    public function print(ServerRequestInterface $request, ResponseInterface $response, Twig $twig, $id)
    {
        if (Receipt::find($id)) {
            ...
            return $twig->render($response, 'receipt/cv/print.twig', compact('receipt', 'workOrders', 'items'));
        }
